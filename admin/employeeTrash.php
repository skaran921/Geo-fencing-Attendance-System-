...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Employee Trash Detail - Admin Panel</title>            
...
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.11.2/build/alertify.min.js"></script>
    ...
    <body onload="getInActiveEmployeeData()">
        ...
        <div class="page-container">
             ...
             <?php include "./header.php";?>    
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Employee Trash</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                       <i class="fa fa-trash-o"></i> Employee Trash Detail's                           
                            </span>
                  <div class="row"><!---row--->                         
                        <div class="col-md-12"><!---col--->                            
                                <div id="employeeTrashData">   
        ...
        <script>
   function getInActiveEmployeeData(){
        $.ajax({
                url:"getTrashEmployee.php",
                success:function(data){
                    $("#employeeTrashData").html(data);
                }
        });  
   }    
  
        // delete employee
           function removeDeleteEmp(emp_id){
                $.ajax({
                    url:"./removeDeleteEmployee.php?emp_id="+emp_id,
                    success:function(data){
                          if(data==="Success"){                                   
                             alertify.success("<span style='color:#fff;font-size:15px;'><i class='fa fa-check-circle'></i> Removed!!!</span>");
                             getInActiveEmployeeData();
                          }else if(data==="Error"){
