...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Attendance Between Period - Employee Panel</title>            
        ...
        <div class="page-container">
             ...
             <?php include "./header.php";?>    
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Attendance Between Period</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                    <i class="fa fa-calendar"></i> Attendance Between Period
                            </span>
                  <div class="row"><!---row--->                         
...
<script>
   function getEmployeeData(){
        $.ajax({
                url:"getEmployeeRecordForAttendanceBetweenPeriod.php",
