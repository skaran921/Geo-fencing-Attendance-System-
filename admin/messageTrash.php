...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Messages Trash Detail - Admin Panel</title>            
...
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.11.2/build/alertify.min.js"></script>
    ...
    <body onload="getInActiveMessageData()">
        ...
        <div class="page-container">
             ...
             <?php include "./header.php";?>    
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Message Trash</li>
                </ul>
                <!-- END BREADCRUMB -->                       
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                       <i class="fa fa-trash-o"></i> Message's Trash Detail's                           
                            </span>
                  <div class="row"><!---row--->                         
                        <div class="col-md-12"><!---col--->                            
                                <div id="messageTrashData">   
        ...
        <script>
   function getInActiveMessageData(){
        $.ajax({
                url:"getTrashMessage.php?admin_id=<?php echo $_SESSION['admin_id'];?>",
                success:function(data){
                    $("#messageTrashData").html(data);
                }
        });  
   }    
  
        // delete employee
           function removeDeleteMessage(message_id){
                $.ajax({
                    url:"./removeDeleteMessage.php?message_id="+message_id,
                    success:function(data){
                          if(data==="Success"){                                   
                             alertify.success("<span style='color:#fff;font-size:15px;'><i class='fa fa-check-circle'></i> Removed!!!</span>");
                             getInActiveMessageData();
                          }else if(data==="Error"){
