...
<html lang="en">
    <head>        
        <!-- META SECTION -->
        <title>Locations Trash - Admin Panel</title>            
...
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.11.2/build/alertify.min.js"></script>
    ...
    <body onload="getLocationTrashData()">
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                         <i class="fa fa-trash-o"></i> Locations Trash Detail's                           
                            </span>
                  <div class="row"><!---row--->                         
                        <div class="col-md-12"><!---col--->                            
                                <div id="locationsTrashData">   
        ...
        <script>
   function getLocationTrashData(){
        $.ajax({
                url:"getTrashLocations.php",
                success:function(data){
                    $("#locationsTrashData").html(data);
                }
        });  
   }    
  
        // delete employee
           function removeDeleteLocation(location_id){
                $.ajax({
                    url:"./removeDeleteLocation.php?location_id="+location_id,
                    success:function(data){
                          if(data==="Success"){                                   
                             alertify.success("<span style='color:#fff;font-size:15px;'><i class='fa fa-check-circle'></i> Removed!!!</span>");
                             getLocationTrashData();
                          }else if(data==="Error"){
