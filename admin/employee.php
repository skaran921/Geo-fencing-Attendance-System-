             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            ...
                            <span style="float:right;margin-right:10px;">
                              <a href="javascript:void(0)" onclick="window.open('./addEmployee.php','_blank')" class="text-decoration:none;" title="Add New Employee" data-toggle="tooltip" data-placement="bottom">
   ...
   function getEmployeeData(){
        ...
        // delete employee
           function deleteEmp(emp_id){
                $.ajax({
                    url:"./deleteEmployee.php?emp_id="+emp_id,
                    success:function(data){
                          if(data==="Success"){                                   
