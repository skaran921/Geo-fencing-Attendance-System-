             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            <span style="padding:10px;background:#000066;color:#fff;text-align:left;font-weight:600;font-size:17px;width:100%;margin-bottom:10px;display:block;">
                                         <i class="fa fa-file-o"></i> Projects Detail's
                            <span style="float:right;margin-right:10px;">
                              <a href="javascript:void(0)" onclick="window.open('./addProject.php','_blank')" class="text-decoration:none;" title="Add New Employee" data-toggle="tooltip" data-placement="bottom">
   ...
   function getProjectData(){
        ...
        // delete employee
           function deleteProject(project_id){
                $.ajax({
                    url:"./deleteProject.php?project_id="+project_id,
                    success:function(data){
                          if(data==="Success"){                                   
