...
<script src="//cdn.jsdelivr.net/npm/alertifyjs@1.11.2/build/alertify.min.js"></script>
    ...
    <body onload="getAssignProjectData()">
        ...
        <div class="page-container">
             ...
             <?php include "./header.php";?>    
                ...
                <div class="page-content-wrap container">
                            ...
                            <i class=""></i>   Assign Project
                            <span style="float:right;margin-right:10px;">
                              <a href="javascript:void(0)" onclick="window.open('./addAssignProject.php','_blank')" class="text-decoration:none;" title="Assign Location" data-toggle="tooltip" data-placement="bottom">
        ...
        <script>
   function getAssignProjectData(){
        $.ajax({
                url:"getAssignProject.php",
        ...
        // delete employee
           function deleteAssignProject(assign_project_id){
                $.ajax({
                    url:"./deleteAssignProject.php?assign_project_id="+assign_project_id,
                    success:function(data){
                          if(data==="Success"){                                   
