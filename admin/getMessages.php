    ...
    <table id="myTable" class=" table table-bordered">
        ...
        <tbody>
         ...
         FROM messages
           ...
           WHERE messages.admin_id='$admin_id' AND messages.status='Active' ORDER BY messages.u_id DESC";
                        ...
                        <form action="" method="post">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    <a href="javascript:void(0)" onclick="alertify.confirm('<h4>Alert</h4>','<h1>Are You Sure?</h1>',function(){deleteMessage(<?php echo $row['message_id'] ?>)},function(){ alertify.warning('Cancel')});">
