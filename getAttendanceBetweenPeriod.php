    ...
    <table id="myTable" class=" table table-bordered">
        ...
        <tbody>
            ...
            $sql = "SELECT checkin.address As checkin_address,checkin.distance As checkin_distance,checkout.address As
                ...
                WHERE checkin.userId='$emp_id' AND DATE(checkin.time) BETWEEN '$start_date' AND '$end_date'  ORDER BY checkin.time DESC
                ,checkout.time DESC;";
            ...
            ?>
                <tr>
                    <td>
                        <?php echo date("d-m-Y", strtotime($row["checkin_time"])); ?>
                        <br>
                        <?php echo date("h:i:s A", strtotime($row["checkin_time"])); ?>
                    </td>
            ...
            <div class="alert alert-info">
                ...
                <p> <b>Period: </b>From <?php echo $_GET["start_date"]; ?> To <?php echo $_GET["end_date"]; ?></p>
