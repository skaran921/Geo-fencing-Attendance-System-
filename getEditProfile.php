 ...
 <?php 
        ...
        ?>              
              <form action="" method="post"><!-----------form start here------------->         
                  <div class="row bg-light"><!---row--->                         
                        <div class="col-md-6"><!---col---> 
                             <div class="row"><!---inside sub row--->  
                                 <div class="col-md-12"><!--col1 inside row---->
                                 ...
                                 <div class="col-md-12"><!--col3 inside row---->
                                    <div class="form-group">
                                        <label>Gender:</label>
                                 ...
                                 <div class="col-md-12" style="margin:2px;"><!--col3 inside row---->
                                    <div class="form-group">                                       
